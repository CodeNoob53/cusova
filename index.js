import{a as D}from"./assets/vendor-BWC8OeqA.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();const z="https://your-energy.b.goit.study/api",v=D.create({baseURL:z}),Q=async()=>{const{data:e}=await v.get("/quote");return e},V=async({filter:e,page:t=1,limit:n=12})=>{const{data:a}=await v.get("/filters",{params:{filter:e,page:t,limit:n}});return a},J=async({bodypart:e,muscles:t,equipment:n,keyword:a,page:i=1,limit:r=10})=>{const s={page:i,limit:r};e&&(s.bodypart=e),t&&(s.muscles=t),n&&(s.equipment=n),a&&(s.keyword=a);const{data:c}=await v.get("/exercises",{params:s});return c},L=async e=>{const{data:t}=await v.get(`/exercises/${e}`);return t},q=async(e,t,n,a="")=>{const i={rate:t,email:n};a&&(i.review=a);const{data:r}=await v.patch(`/exercises/${e}/rating`,i);return r},K=async e=>{const{data:t}=await v.post("/subscription",{email:e});return t},Z=`<li class="exercise-card" data-id="{{id}}">
...
`,ee={"exercise-card":Z,"category-card":W,"favorite-card":Y,"favorites-empty":G,pagination:X},M={...ee},y=async e=>M[e]?M[e]:(console.warn(`Template not found in bundle: ${e}`),""),I=(e,t)=>e.replace(/\{\{(\w+)\}\}/g,(n,a)=>t[a]!==void 0?t[a]:""),te=e=>{const t=document.getElementById("quote-text"),n=document.getElementById("quote-author");t&&e.quote&&(t.textContent=e.quote),n&&e.author&&(n.textContent=e.author)},ne=async(e,t)=>{const n=document.getElementById(t);if(!n)return;if(e.length===0){n.innerHTML='<p class="no-results">No exercises found. Try another filter.</p>';return}const a=await y("exercise-card"),i=e.map(r=>I(a,{id:r._id,rating:r.rating||0,ratingFormatted:r.rating?r.rating.toFixed(1):"0.0",name:r.name,burnedCalories:r.burnedCalories||0,time:r.time||0,bodyPart:r.bodyPart||"N/A",target:r.target||"N/A"})).join("");n.innerHTML=`<ul class="exercises-grid">${i}</ul>`},ae=async(e,t)=>{const n=document.getElementById(t);if(!n)return;if(e.length===0){n.innerHTML='<p class="no-results">No categories found.</p>';return}const a=await y("category-card"),i=e.map(r=>I(a,{filter:r.filter,name:r.name,imgURL:r.imgURL||""})).join("");n.innerHTML=`<ul class="categories-grid">${i}</ul>`},N=(e,t,n=9)=>{const a=document.getElementById(t);if(!a)return;let i="";e==="categories"?(i=Array(n).fill('<li class="category-skeleton skeleton-shimmer"></li>').join(""),a.innerHTML=`<ul class="categories-grid">${i}</ul>`):(i=Array(n).fill(`
    ...
    `}const i=document.getElementById("modal-target");i&&(i.textContent=e.target||"N/A");const r=document.getElementById("modal-bodypart");r&&(r.textContent=e.bodyPart||"N/A");const s=document.getElementById("modal-equipment");s&&(s.textContent=e.equipment||"N/A");const c=document.getElementById("modal-popular");c&&(c.textContent=e.popularity||"0");const d=document.getElementById("modal-calories");d&&(d.textContent=`${e.burnedCalories||0}/${e.time||0} min`);const u=document.getElementById("modal-description");u&&(u.textContent=e.description||"No description available.");const g=document.getElementById("exercise-modal");g&&(g.dataset.exerciseId=e._id)},R=()=>{m("exercise-modal"),w("rating-modal"),H(),oe()},f=()=>{m("rating-modal"),w("exercise-modal"),H()},H=()=>{const e=document.querySelectorAll("#rating-modal .rating-star"),t=document.getElementById("rating-display-value"),n=document.getElementById("rating-email"),a=document.getElementById("rating-review");e.forEach(i=>i.classList.remove("active")),t&&(t.textContent="0.0"),n&&(n.value="",n.classList.remove("error")),a&&(a.value="")},oe=()=>{const e=document.getElementById("rating-stars"),t=document.getElementById("rating-display-value");e&&e.dataset.listenerAttached!=="true"&&(e.dataset.listenerAttached="true",e.addEventListener("click",n=>{const a=n.target.closest(".rating-star");if(!a)return;const i=parseFloat(a.dataset.rating),r=e.querySelectorAll(".rating-star"),s=Array.from(r).indexOf(a);r.forEach((c,d)=>{d<=s?c.classList.add("active"):c.classList.remove("active")}),t&&(t.textContent=i.toFixed(1))}),e.addEventListener("mouseover",n=>{const a=n.target.closest(".rating-star");if(!a)return;const i=e.querySelectorAll(".rating-star"),r=Array.from(i).indexOf(a);i.forEach((s,c)=>{c<=r?s.classList.add("hover"):s.classList.remove("hover")})}),e.addEventListener("mouseleave",()=>{e.querySelectorAll(".rating-star").forEach(a=>a.classList.remove("hover"))}))},O=()=>{const e=document.getElementById("rating-display-value");return e?parseFloat(e.textContent):0},x="quote-of-the-day";function $(){return new Date().toISOString().split("T")[0]}function ce(){try{const e=localStorage.getItem(x);if(!e)return null;const{quote:t,author:n,date:a}=JSON.parse(e),i=$();return a===i?{quote:t,author:n}:(localStorage.removeItem(x),null)}catch(e){return console.error("Error reading cached quote:",e),null}}function le(e,t){try{const n={quote:e,author:t,date:$()};localStorage.setItem(x,JSON.stringify(n))}catch(n){console.error("Error caching quote:",n)}}async function P(){try{let e=ce();e||(e=await Q(),le(e.quote,e.author)),te(e)}catch(e){console.error("Failed to initialize quote:",e)}}const C="favoriteExercises";function B(){try{const e=localStorage.getItem(C);return e?JSON.parse(e):[]}catch(e){return console.error("Failed to get favorites:",e),[]}}function de(e){try{const t=B();return t.some(n=>n._id===e._id)?!1:(t.push(e),localStorage.setItem(C,JSON.stringify(t)),!0)}catch(t){return console.error("Failed to add favorite:",t),!1}}function _(e){try{const n=B().filter(a=>a._id!==e);return localStorage.setItem(C,JSON.stringify(n)),!0}catch(t){return console.error("Failed to remove favorite:",t),!1}}function b(e){return B().some(n=>n._id===e)}async function ue(){const e=document.getElementById("favorites-container");if(!e)return;const t=await y("favorites-empty");e.innerHTML=t}async function F(){const e=document.getElementById("favorites-container");if(!e)return;const t=B();if(t.length===0){await ue();return}const n=await y("favorite-card"),a=t.map(i=>I(n,{id:i._id,name:i.name,burnedCalories:i.burnedCalories||0,bodyPart:i.bodyPart||"N/A",target:i.target||"N/A"})).join("");e.innerHTML=`<ul class="favorites-grid">${a}</ul>`}function me(e){const t=document.getElementById("modal-close-btn");t&&(t.onclick=()=>m("exercise-modal"));const n=document.getElementById("give-rating-btn");n&&(n.onclick=()=>{R(),ge(e)});const a=document.getElementById("add-to-favorites-btn");a&&(a.onclick=async()=>{b(e)&&(_(e),m("exercise-modal"),await F())},b(e)&&(a.textContent="Remove from favorites"));const i=document.getElementById("exercise-modal");i&&(i.onclick=s=>{s.target===i&&m("exercise-modal")});const r=s=>{s.key==="Escape"&&(m("exercise-modal"),document.removeEventListener("keydown",r))};document.addEventListener("keydown",r)}function ge(e){const t=document.getElementById("rating-modal-close-btn");t&&(t.onclick=()=>f());const n=document.getElementById("rating-form");n&&(n.onsubmit=async r=>{r.preventDefault();const s=O(),c=document.getElementById("rating-email"),d=document.getElementById("rating-review"),u=c?.value.trim(),g=d?.value.trim()||"";if(s<=0){alert("Please select a rating");return}if(!u){alert("Please enter your email"),c?.focus();return}try{await q(e,s,u,g),alert("Rating submitted successfully!"),f()}catch(l){console.error("Failed to submit rating:",l),l.message?.includes("409")?alert("This email has already been used to rate this exercise"):alert("Failed to submit rating. Please try again.")}});const a=document.getElementById("rating-modal");a&&(a.onclick=r=>{r.target===a&&f()});const i=r=>{r.key==="Escape"&&(f(),document.removeEventListener("keydown",i))};document.addEventListener("keydown",i)}async function fe(){const e=document.querySelector(".favorites-page");try{await P(),await F(),pe()}catch(t){console.error("Error initializing favorites page:",t)}finally{e&&e.classList.add("loaded")}}function pe(){const e=document.getElementById("favorites-container");e&&e.dataset.listenerAttached!=="true"&&(e.dataset.listenerAttached="true",e.addEventListener("click",async t=>{const n=t.target.closest(".favorite-delete-btn");if(n){t.stopPropagation();const i=n.dataset.id;if(i){_(i);try{await F()}catch(r){console.error("Failed to render favorites:",r)}}return}const a=t.target.closest(".favorite-start-btn");if(a){t.stopPropagation();const i=a.dataset.id;if(!i)return;try{const r=await L(i);k(r),w("exercise-modal"),me(i)}catch(r){console.error("Failed to fetch exercise details:",r),alert("Failed to load exercise details.")}}}))}function ve(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}const o={view:"categories",filter:"Muscles",category:null,categoryFilter:null,keyword:"",page:1},E=()=>window.innerWidth<768?9:o.view==="categories"?12:10;async function ye(){const e=document.querySelector(".main-content"),t=E();N(o.view,"exercises-container",t);try{await P(),await p()}catch(n){console.error("Error initializing home page:",n)}finally{e&&e.classList.add("loaded")}Ee(),Le(),re(be),he()}function he(){let e,t=E();window.addEventListener("resize",()=>{clearTimeout(e),e=setTimeout(()=>{const n=E();n!==t&&(t=n,o.page=1,p())},300)})}async function p(){const e=document.getElementById("exercises-container");try{const t=E();if(N(o.view,"exercises-container",t),o.view==="categories"){const n=await V({filter:o.filter,page:o.page,limit:t});ae(n.results,"exercises-container"),A(n.page?Number(n.page):1,n.totalPages||1)}else{const n={limit:t,page:o.page};o.categoryFilter==="Muscles"?n.muscles=o.category.toLowerCase():o.categoryFilter==="Body parts"?n.bodypart=o.category.toLowerCase():o.categoryFilter==="Equipment"&&(n.equipment=o.category.toLowerCase()),o.keyword&&(n.keyword=o.keyword);const a=await J(n);ne(a.results,"exercises-container"),A(a.page?Number(a.page):1,a.totalPages||1)}}catch(t){console.error("Fetch error:",t),e&&(e.innerHTML='<p class="error-message">Failed to load data. Please try again.</p>')}}function be(e){e&&e!==o.page&&(o.page=e,p(),se())}function Ee(){const e=document.getElementById("filter-tabs");e&&e.dataset.listenerAttached!=="true"&&(e.dataset.listenerAttached="true",e.addEventListener("click",async t=>{const n=t.target.closest(".filter-tab");if(n){document.querySelectorAll(".filter-tab").forEach(a=>a.classList.remove("active")),n.classList.add("active"),o.filter=n.dataset.filter,o.view="categories",o.page=1,o.keyword="",o.category=null,Be();try{await p()}catch(a){console.error("Failed to fetch data:",a)}}}))}function Le(){const e=document.getElementById("exercises-container");e&&e.dataset.listenerAttached!=="true"&&(e.dataset.listenerAttached="true",e.addEventListener("click",async t=>{const n=t.target.closest(".category-card");if(n){const i=n.dataset.name,r=n.dataset.filter;if(!i)return;o.view="exercises",o.category=i,o.categoryFilter=r,o.page=1,o.keyword="",we(i),xe();try{await p()}catch(s){console.error("Failed to fetch exercises:",s)}return}const a=t.target.closest(".exercise-start-btn");if(a){const i=a.dataset.id;if(!i)return;try{const r=await L(i);k(r),w("exercise-modal"),Ie(i)}catch(r){console.error(`Failed to fetch exercise details for ${i}:`,r),alert("Failed to load exercise details. Please try again.")}}}))}function we(e){const t=document.getElementById("section-title"),n=document.getElementById("exercise-search-form");t&&(t.innerHTML=`Exercises / <span class="category-name">${e}</span>`),n&&n.classList.remove("hidden")}function Be(){const e=document.getElementById("section-title"),t=document.getElementById("exercise-search-form"),n=document.getElementById("exercise-search-input"),a=document.getElementById("exercise-clear-btn");e&&(e.textContent="Exercises"),t&&t.classList.add("hidden"),n&&(n.value=""),a&&a.classList.add("hidden")}function xe(){const e=document.getElementById("exercise-search-form"),t=document.getElementById("exercise-search-input"),n=document.getElementById("exercise-clear-btn");!e||!t||e.dataset.listenerAttached!=="true"&&(e.dataset.listenerAttached="true",t.addEventListener("input",()=>{t.value.trim()?n.classList.remove("hidden"):n.classList.add("hidden")}),n.addEventListener("click",async()=>{t.value="",n.classList.add("hidden"),t.focus(),o.keyword="",o.page=1;try{await p()}catch(a){console.error("Failed to fetch exercises:",a)}}),e.addEventListener("submit",async a=>{a.preventDefault();const i=t.value.trim();o.keyword=i,o.page=1;try{await p()}catch(r){console.error("Failed to search exercises:",r)}}))}function Ie(e){const t=document.getElementById("modal-close-btn");t&&(t.onclick=()=>m("exercise-modal"));const n=document.getElementById("give-rating-btn");n&&(n.onclick=()=>{R(),ke(e)});const a=document.getElementById("add-to-favorites-btn");a&&(a.onclick=async()=>{if(b(e))alert("This exercise is already in your favorites");else{const s=await L(e);de(s),a.innerHTML=`
          Added to favorites
        ...
        `,setTimeout(()=>{a.textContent="Add to favorites"},2e3)}},b(e)&&(a.textContent="Already in favorites",a.disabled=!0,a.style.opacity="0.6"));const i=document.getElementById("exercise-modal");i&&(i.onclick=s=>{s.target===i&&m("exercise-modal")});const r=s=>{s.key==="Escape"&&(m("exercise-modal"),document.removeEventListener("keydown",r))};document.addEventListener("keydown",r)}function ke(e){const t=document.getElementById("rating-modal-close-btn");t&&(t.onclick=()=>f());const n=document.getElementById("rating-form");n&&(n.onsubmit=async r=>{r.preventDefault();const s=O(),c=document.getElementById("rating-email"),d=document.getElementById("rating-review"),u=c?.value.trim(),g=d?.value.trim()||"";if(s<=0){alert("Please select a rating");return}if(!u){alert("Please enter your email"),c?.focus();return}if(!ve(u)){alert("Please enter a valid email address"),c?.classList.add("error"),c?.focus();return}c?.classList.remove("error");try{await q(e,s,u,g),alert("Rating submitted successfully!"),f();const l=await L(e);k(l)}catch(l){console.error("Failed to submit rating:",l),l.message?.includes("409")?alert("This email has already been used to rate this exercise"):alert("Failed to submit rating. Please try again.")}});const a=document.getElementById("rating-modal");a&&(a.onclick=r=>{r.target===a&&f()});const i=r=>{r.key==="Escape"&&(f(),document.removeEventListener("keydown",i))};document.addEventListener("keydown",i)}function Ce(){const e=document.getElementById("burger-btn"),t=document.getElementById("mobile-menu"),n=document.getElementById("mobile-close-btn");if(!e||!t||!n)return;e.addEventListener("click",Fe),n.addEventListener("click",h),t.addEventListener("click",i=>{i.target===t&&h()}),t.querySelectorAll(".mobile-nav-link").forEach(i=>{i.addEventListener("click",()=>{h()})}),document.addEventListener("keydown",i=>{i.key==="Escape"&&t.classList.contains("is-open")&&h()})}function Fe(){const e=document.getElementById("mobile-menu"),t=document.getElementById("burger-btn");e&&(e.classList.add("is-open"),document.body.style.overflow="hidden"),t&&t.setAttribute("aria-expanded","true")}function h(){const e=document.getElementById("mobile-menu"),t=document.getElementById("burger-btn");e&&(e.classList.remove("is-open"),document.body.style.overflow=""),t&&t.setAttribute("aria-expanded","false")}document.addEventListener("DOMContentLoaded",()=>{Ce()});function Te(){return window.location.hash.slice(1)||"home"}function Me(e){const t=document.getElementById("home-page"),n=document.getElementById("favorites-page");e==="home"?(t?.classList.remove("hidden"),n?.classList.add("hidden"),ye()):e==="favorites"&&(t?.classList.add("hidden"),n?.classList.remove("hidden"),fe()),Ae(e)}function Ae(e){const t=document.getElementById("nav-home"),n=document.getElementById("nav-favorites");!t||!n||(t.classList.remove("active"),n.classList.remove("active"),e==="favorites"?n.classList.add("active"):t.classList.add("active"))}function S(){const e=Te();Me(e)}function Se(){window.addEventListener("hashchange",S),S()}function qe(){const e=document.getElementById("subscription-form");e&&e.addEventListener("submit",async t=>{t.preventDefault();const n=e.email.value;try{await K(n),alert("Successfully subscribed!"),e.reset()}catch{alert("Subscription failed. Please check your email or try again later.")}})}document.addEventListener("DOMContentLoaded",()=>{Se(),qe()});
